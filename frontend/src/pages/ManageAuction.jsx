      ...
      {visibleAds.length === 0 ? (
        ...
        >
          <div className="market-grid">
            {visibleAds.map((ad) => (
              <div
                className={`market-card ${ad.isClosed ? "ad-closed" : "ad-active"}`}
                key={ad._id}
                data-testid={`auction-card-${ad._id}`}
              >
                <div
                  style={{
                    width: "100%",
                ...
                <div>
                  <h3 data-testid={`auction-title-${ad._id}`}>{ad.title}</h3>
                  <p>
                  ...
                  >
                    ...
                    {ad.isClosed && (
                      <span
                        ...
                        data-testid={`closed-label-${ad._id}`}
                      >
                        Closed
                      </span>
                    )}
